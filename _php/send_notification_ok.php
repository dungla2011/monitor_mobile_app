...
// Khởi tạo Firebase
$factory = (new Factory)
    ->withServiceAccount('e:\Projects\MonitorApp2025\fb.json')
...
$deviceToken = "fTXg7O77T5agRbuTQ8AxIC:APA91bETm8NyhOTjVxMn_jnEi-D9MixWAdP-67Db1_Hp6IidFF_v6fwNEbcG9fjZJfQgwW5MUVft6WaPWx2kCD0nFkK5t_8_9301UEf7PuphAi0tq-J5sNc";
...
$customData = [
    'title' => $title,  // ⚠️ QUAN TRỌNG: Thêm title vào data để background handler hiển thị
    'body' => $body,    // ⚠️ QUAN TRỌNG: Thêm body vào data để background handler hiển thị
    'device_id' => 'ABC123',
